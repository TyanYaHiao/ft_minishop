...
<div class="top" id="intro-top">
    ...
    <div class="container">
        ...
        <div id="A3" class="product_cart_block">
        ...
        <div id="A4" class="product_cart_block">
        ...
        <div id="A5" class="product_cart_block">
        ...
        <div id="A6" class="product_cart_block">
        ...
        <div id="A7" class="product_cart_block">
        ...
        <div id="A8" class="product_cart_block">
        ...
        <div id="TT" class="product_cart_block">
        ...
        <div id="Q7" class="product_cart_block">
        ...
        <div id="Q8" class="product_cart_block">
        ...
        <div id="RS7" class="product_cart_block">
        ...
        <div id="TT RS" class="product_cart_block">
    ...
    <div class="summ">
        <p class="text">Final pricing: <br> Quantity:
            <form>
                <p class="order"><input type="button" value="  Order  "></p>
            </form>
